#/*****************************************************************************
# * | File        :      SH1106.py
# * | Author      :   JVTeleco. Based on original from Waveshare team
# * | Function    :   SH1106 1.3 OLED SPI / I2C  for Raspberry
# * | Info        :   Default is SPI device. To change to I2C, need to resolder resistors
# *                   on the back of the unit and change define of mode_SPI from True to False
# *----------------
# * | This version:   V1.2
# * | Date        :   2021-11-01
# * | Info        :   #update to python3:  integer division with //
# ******************************************************************************/
...
#DEFINE:
##Change mode_SPI for SPI or I2C mode
mode_SPI = True #Change to False for I2C mode
